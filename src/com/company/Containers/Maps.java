package com.company.Containers;//: containers/Maps.java
// Things you can do with Maps. 670

import com.company.net.mindview.util.CountingMapData;
...
public class Maps {
  ...
  public static void test(Map<Integer,String> map) {
    ...
    print(map.values());
    print(map);
    print("map.containsKey(4): " + map.containsKey(4));
    print("map.get(4): " + map.get(4));
    print("map.containsValue(\"B0\"): "
      + map.containsValue("B0"));
