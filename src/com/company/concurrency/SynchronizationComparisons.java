package com.company.concurrency;//: concurrency/SynchronizationComparisons.java
// Comparing the performance of explicit Locks
// and Atomics versus the synchronized keyword. 1016
...
import static com.company.net.mindview.util.Print.printf;
...
abstract class Accumulator {
  ...
  protected static volatile int[] preLoaded = new int[SIZE];
  static {
