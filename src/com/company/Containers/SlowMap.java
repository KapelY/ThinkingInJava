package com.company.Containers;//: containers/SlowMap.java
// A Map implemented with ArrayLists.678
...
public class SlowMap<K,V> extends AbstractMap<K,V> {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(m.get("BURKINA FASO"));
    System.out.println(m.entrySet());
    m.entrySet().forEach((e) -> System.out.print(e.getClass().getSimpleName() + " "));
    m.keySet().clear();
    System.out.print("\n2------    ");
    m.entrySet().forEach((e) -> System.out.print(e.getClass().getSimpleName() + " "));
    System.out.println();
