package com.company.concurrency;//: concurrency/MapComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe Map performance. 1027
import com.company.net.mindview.util.CountingGenerator;
import com.company.net.mindview.util.MapData;
